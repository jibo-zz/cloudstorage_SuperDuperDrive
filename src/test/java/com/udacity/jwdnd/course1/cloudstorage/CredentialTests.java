...
class CredentialTests extends CloudStorageApplicationTests {
    ...
    public static final String BEATLES_URL = "https://www.udacity.com/";
    public static final String MCCARTNEY_USERNAME = "ahmed";
    public static final String MCCARTNEY_PASSWORD = "hamada";
    public static final String RINGO_URL = "http://www.code.org/";
    public static final String RINGO_USERNAME = "marwa";
    public static final String RINGO_PASSWORD = "marmar";
    ...
    public void testDeletion() {
        ...
        createCredential("http://www.jiboman.com/", "jibo", "jibo", homePage);
